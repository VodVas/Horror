...
public class FacialExpressionController : MonoBehaviour, IFacialExpressionController
{
    ...
    void ApplyBlendShapeWeight(BlendShape blendShape, float weight)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    void SetBlendShapeWeightDirect(BlendShape blendShape, float weight)
    {
